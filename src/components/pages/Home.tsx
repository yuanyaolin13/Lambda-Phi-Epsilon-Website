    ...
    <div className="w-full flex flex-col">
      <article
        ...
        <div
          ...
          <div className="flex flex-col sm:flex-row justify-center m-2 w-full">
            <div ref={ref}
                 className={`fade-up ${visible ? "visible" : ""} flex flex-col w-full align-middle justify-center`}>
      ...
      <article className="relative w-full flex bg-white">
        <div
          ...
          <div
            className="lg:-rotate-90 lg:mt-64 lg:text-8xl text-5xl font-extrabold text-blue-700 flex flex-col justify-center">
            <div>
              WHO ARE
            </div>
            <div>
          ...
          <div className="flex-1 lg:px-24 lg:p-12 relative mt-6 justify-center ">
            <div className='relative flex justify-center'>
              <div
                className="absolute inset-0 bg-[url(./assets/officialKanji.webp)] bg-no-repeat bg-center bg-contain opacity-10"></div>
              <div className="text-gray-800 text-md lg:text-lg">
                <span className='font-bold'>Lambda Phi Epsilon</span> at UNC Chapel Hill is an
                Asian-interest, non-Asian-exclusive fraternity founded in
                the Spring of 2013 by 18 young men. We strive to represent the Asian-American
                community in
                exemplifying our core values of authenticity, courageous leadership, cultural
                heritage, love, and
                wisdom.
              </div>
            </div>
      ...
      <article className="bg-[url(./assets/graintexture.webp)] relative h-full">
        <div className="relative w-full">
          <svg viewBox="0 0 1440 200" fill="#FFFFFF" xmlns="http://www.w3.org/2000/svg"
               className={'-mt-px'}>
            <path
        ...
        <div className='flex flex-col lg:mx-64 lg:space-y-20 my-4 px-8 lg:mt-12'>
          <div className='flex flex-col lg:flex-row items-center'>
            <div className='flex flex-col w-full lg:w-1/2'>
              ...
              <div className='px-8'>A world where Lambda men live fulfilling lives and contribute
            ...
            <div className='flex flex-col w-full lg:w-1/2 mt-8 lg:mt-0'>
              ...
              <div className='px-8'>To guide men on a lifelong discovery of authenticity and
                personal growth.
              </div>
            </div>
          </div>
        ...
        <div className="relative">
          <svg viewBox="0 0 1440 658" fill="#FFFFFF" xmlns="http://www.w3.org/2000/svg"
